...
![contribution to deno_lint repo this year](/img/deno-lint-commits-2020.png)
...
![contribution to deno repo this year](/img/deno-commits-2020.png)
*deno への commit 量*
...
![shimoda view from mountain](/img/shimoda-view.png)
*下田の寝姿山からの景色*

![view from hotel's room](/img/hotel-room-view.png)
*宿の部屋からの眺め*
...
![compiler textbooks](/img/compiler-textbooks.png)
*コンパイラ3種の神器*
