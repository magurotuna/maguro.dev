...
date: 2020-01-06
tags: ["Rust", "itertools"]
description: "itertools::joinは遅い、collectしてからjoinする方が3倍速い"
---
...
![Benchmark chart](/img/itertools-join-benchmark.png)
...
[magurotuna/rust-join-iterator-str-bench](https://github.com/magurotuna/rust-join-iterator-str-bench)
