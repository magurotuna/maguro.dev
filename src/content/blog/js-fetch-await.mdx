...
READMEの先頭に **極楽要求（しなさい）** と書いてあることで有名（？）な[ky](https://github.com/sindresorhus/ky) はどうでしょうか。
...
Rust の [reqwest](https://github.com/seanmonstar/reqwest) も同じパターンです。
...
Python の [aiohttp](https://docs.aiohttp.org/en/stable/) はおもしろくて、公式ドキュメントの [The aiohttp Request Lifecycle](https://docs.aiohttp.org/en/stable/http_request_lifecycle.html)というページでまさにこの問題について解説をしています。
