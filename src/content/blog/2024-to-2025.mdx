...
date: 2024-12-30
tags: ["Deno", "Rust", "career", "school", "recap"]
description: "Georgia Tech最難関クラス攻略、DenoのHTTP/2バグ修正、登壇デビューの1年"
---
...
<figure>
  <img src="/img/oms-central-workload.png" alt="Course lists in OMS Central sorted by workload" />
  <figcaption>Workloadで降順ソートした結果。Distributed Computingが2位に大差をつけて圧倒的作業量を要していることが分かる。ちなみに数値は週あたりの作業時間数を表している</figcaption>
</figure>
...
[dslabs](https://github.com/emichael/dslabs)
...
<figure>
  <img src="/img/oms-central-workload.png" alt="Course lists in OMS Central sorted by workload" />
  <figcaption>先ほどと同じ画像。圧倒的1位のDistributed Computingに次ぐ2位がCompilers</figcaption>
</figure>
...
[Proposal: change the default value of `initial_max_send_streams` to 100](https://github.com/hyperium/h2/issues/731)
...
[(de)compression: reduce memory allocation to improve performance #521](https://github.com/tower-rs/tower-http/pull/521)
...
[YouTube出演動画プレイリスト](https://www.youtube.com/playlist?list=PLoY7eQaqfInPB_L2LGXqMABgQ33-ZYsxI)
